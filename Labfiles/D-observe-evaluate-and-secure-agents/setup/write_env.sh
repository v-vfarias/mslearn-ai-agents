...
echo "Task 1 needs Application Insights connected to your project (Agents > Traces > Connect in the portal), and Task 2 needs a grounded agent to evaluate: from the Python folder, run 'python ../setup/bootstrap_agent.py'."
